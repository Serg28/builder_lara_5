    ...
    <form id="form_page" class="smart-form" enctype="multipart/form-data" method="post" novalidate="novalidate">
            ...
            <div class="row">
                <section class="col" style="float: none">
                    ...
                    <div style="position: relative;">
                        <label class="input">
                            <input type="text" value="{{{ $info->phrase ?? "" }}}"
                                   onkeyup="Trans.getTranslate(this.value)" name="phrase"
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-success btn-sm"><span
                        class="glyphicon glyphicon-floppy-disk"></span> {{__cms('Сохранить')}} </button>
