            ...
            <div id="dt_basic_filter" class="dataTables_filter">
                <form action="" method="get" id="search_form">
                  ...
                  <i class="glyphicon glyphicon-search"></i>
                        ...
                        <input class="form-control" name="search_cms_q" type="search" value="{{$search_q}}"
            ...
            <tr class="tr_{{$phrase->id}} " id_page="{{$phrase->id}}">
                ...
                <td style="text-align: left">
                    ...
                    @foreach($langs as $languageKey=>$languageValue)
                        <p>
                            <img class="flag flag-{{str_replace(['en', 'uk'],  ['us', 'ua'], $languageKey)}}"
                ...
                <td>
                    <div class="btn-group hidden-phone pull-right">
                        <a class="btn dropdown-toggle btn-xs btn-default" data-toggle="dropdown"><i
                                    class="fa fa-cog"></i> <i class="fa fa-caret-down"></i></a>
                        <ul class="dropdown-menu pull-right" id_rec="{{$phrase->id}}">
                            <li>
                                <a onclick="Trans.doDelete({{$phrase->id}});"><i
                                            class="fa red fa-times"></i> {{__cms("Удалить")}}</a>
                            </li>
                        </ul>
                    </div>
                </td>
