<script src="/packages/linecore/cms/js/footer_all.js?2"></script>
<script src='/packages/linecore/cms/js/plugin/editor_floala/js/languages/{{str_replace('uk', 'ua', $thisLang) }}.js'></script>
