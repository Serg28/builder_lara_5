...
<html lang="en-us">
	<head>
		...
		<!-- Basic Styles -->
		<link rel="stylesheet" type="text/css" media="screen" href="/packages/linecore/cms/css/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" media="screen" href="/packages/linecore/cms/css/font-awesome.min.css">

		<!-- SmartAdmin Styles : Please note (smartadmin-production.css) was created using LESS variables -->
		<link rel="stylesheet" type="text/css" media="screen" href="/packages/linecore/cms/css/smartadmin-production.min.css">
